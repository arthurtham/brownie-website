...
<head>
	<?php $title = "BrowntulStar - Shoutcasting" ?>
...
<body>
	...
	<div class="container body-container" style="padding-top:50px;padding-bottom:100px">
        ...
        <p>I am an amateur shoutcaster, with a current non-exclusive casting role for Rooyemi's VALORANT tournaments and for Change Thru Games' VALORANT and Tetris tournaments.</p>
        ...
        <h2>Highlights</h2>
        <div id="carouselVideos" class="carousel carousel-dark slide" data-bs-ride="carousel" style="min-height:600px">

...
?>
									...
									if (!$cache->isHit() || isset($_GET["cache"])) {
										...
										$rewards_table_selection_contents = array(
											"1star" => array('id' => '1star', 'label' => '1★ Rewards', 'rewards' => array()),
											"2star" => array('id' => '2star', 'label' => '2★ Rewards', 'rewards' => array()),
											"3star" => array('id' => '3star', 'label' => '3★ Rewards', 'rewards' => array()),
											"0star" => array('id' => '0star', 'label' => 'Unlisted'   , 'rewards' => array())
										);
										
										$sql_rewards = "SELECT * FROM `iriam_rewards` WHERE `published`=1 ORDER BY `1star` DESC, `2star` DESC, `3star` DESC, `iriam_reward_date` DESC, `iriam_reward_name` ASC;";

...
class CloudinarySigner {
    ...
    public function __construct() {
        ...
        $this->cldUrlPattern = '/(?:https:\/\/res.cloudinary.com\/browntulstar\/)(image|video)\/(private|authenticated|upload)\/(.*\/?)(com\.browntulstar|brownieval)\/(.\S*\.(webp|mov|mp4|jpg|png|gif)*)/';
    }
    ...
    public function signUrl($url) {
        ...
        2	=>	Delivery Type
        3	=>	Transformation
        4   =>  "com.browntulstar" or "brownieval" (literal)

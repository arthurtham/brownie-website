...
<script>
    function renderEmbed() {
        var result = "<iframe width='100%' height='500px' scrolling='yes' frameborder='0' src=" + document.getElementById("announcement_embed").value + ">";
...
<form action="announcement_process.php" method="post">
    ...
    <button type="button" onclick="renderEmbed()">Preview Embed</button><button id="submit" name="submit">Post to DB</button><br/>
    <label for ="announcement_embed">Announcement Embed Link</label>:<br><textarea style="width:100%;height:100px" id="announcement_embed" name="announcement_embed">$announcement_embed</textarea><br/>
</form>

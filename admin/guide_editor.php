...
$html_guide_types = "<span class=\"input-group-text\"><label for ='guide_type'>Category</label></span><select class=\"form-control\" name='guide_type' id='guide_type'>";
...
<div class="row"><div class="col"><h1>Guide Editor</h1></div></div>
<div class="row">
...
<form action="guide_process.php" method="post">
    <div class="input-group mb-3">
        ...
        <input class="form-control" type="text" id="guide_name" name="guide_name" value="$guide_name" /> 
    </div>
    ...
    <div class="input-group mb-3">
        ...
        <input class="form-control" type="text" id="guide_summary" name="guide_summary" value="$guide_summary" /> 
    </div>
    <div class="input-group mb-3">
    $html_guide_types
    </div>
    ...
    <div class="input-group mb-3">
        <span class="input-group-text"><label for ="guide_visible">Browseable</label></span>
        <span class="input-group-text">
            <input class="form-check-input mt-0" type="checkbox" id="guide_visible" name="guide_visible" value="1" $guide_visible />
        </span>
        <span class="input-group-text"><label for ="guide_published">Published</label></span>
        <span class="input-group-text">
        ...
        <input required class="form-control" type="text" id="guide_url" name="guide_url" value="$guide_url" /> 
    </div>
    <button class="btn btn-primary" type="button" onclick="openmarkdown()">Open Guide Editor</button>
    <button class="btn btn-danger" id="submit" name="submit">Save Guide</button> 
    |
    <button class="btn btn-dark" type="button" onclick="restoreguideeditorcontents()">Restore Local Autosave</button>
    <a target="_blank" href="cloudinary.php"><button class="btn btn-dark" type="button">Media Signer</button></a>
    |
    <a href="guide.php"><button class="btn btn-dark" type="button">Back to Guide Post Listings</button></a>
